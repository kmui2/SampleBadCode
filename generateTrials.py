...
def generateTrials(subjCode, seed, mappingType, labelOrder, categoryStructure):
    ...
    if categoryStructure == "5-4":
        header = separator.join(('part', 'block', 'trialType', 'stim', 'labelLeft', 'labelRight',
                                 'correctLabel', 'correctResp', 'correctCategoryD1', 'correctCategoryD2', 'correctCategorySim'))
    else:
        header = separator.join(('part', 'block', 'trialType', 'stim', 'labelLeft', 'labelRight', 'correctLabel',
                                 'correctResp', 'correctCategoryCC', 'correctCategoryR1', 'correctCategoryR2', 'correctCategoryKP'))
